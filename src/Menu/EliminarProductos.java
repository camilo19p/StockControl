...
public class EliminarProductos extends javax.swing.JFrame {
     ...
     */
    public EliminarProductos(GestorProductos gProductos) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         String nombreProductoSeleccionado = jTextField1.getText();
            ...
            for (Producto producto : gProductos.getListaProductos()) {
                if (producto.getCodigo().equalsIgnoreCase(nombreProductoSeleccionado)) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "PRODUCTO ELIMINADO CON EXITO", "ELIMINAR PRODUCTO", JOptionPane.PLAIN_MESSAGE);
                    }
                    return;
                }
            }else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarProductos(gProductos).setVisible(true);
            }
        });
    }
